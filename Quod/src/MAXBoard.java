...
public class MAXBoard implements Cloneable {
	...
	private MAXBoard clone; // clone for the board
	 ...
	 * 
	 */
	public MAXBoard(int sizeX, int sizeY) {
	 ...
	 */
	@Override
	public MAXBoard clone() throws CloneNotSupportedException {
		try {
			clone = (MAXBoard) super.clone();

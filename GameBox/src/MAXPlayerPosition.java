...
public class MAXPlayerPosition {
	 ...
	 *            - Y size of the board
	 */
	public MAXPlayerPosition(int boardDimensionX, int boardDimensionY, int playerCount) {
		...
		case 4:
			...
			break;
		default:
			MAXIO.writeln("error in creating player positions");
			break;
		}
	}
